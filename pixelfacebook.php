...
class Pixelfacebook extends Module
{
	/**
	...
	*/
	public function install()
	{
        ...
        Configuration::updateValue('pixel_facebook_active', false);
        // $this->registerHook('display') deleteByName('facebook_pixel_id') ||
